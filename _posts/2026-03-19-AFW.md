...
There's a lot more I want to do with this — a real-time TUI dashboard, desktop notifications when unknown apps try to connect, per-app bandwidth limiting, and eventually an interactive prompt mode like Little Snitch where you can allow or deny connections as they happen.
