...
tags: [honeypot, ssh, unraid, monitoring, security, intrusion monitoring, attacker behavior, threat intelligence, network security, infrastructure security, logging, metrics, observability, defensive security, server hardening, security research]
image:
  path: https://avatars.githubusercontent.com/u/2387206?s=280&v=4
---
...
{% include embed/youtube.html id="FX1VInpapKM" %}